        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <label
              ...
              className="block text-xs font-medium text-charcoal-500 dark:text-warm-300"
            >
              {t("auth.password")}
            </label>
            <Link
              to="/reset-password"
              className="text-xs font-medium text-burnt-400 hover:text-burnt-500 dark:text-burnt-300 dark:hover:text-burnt-200 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-burnt-300 rounded"
            >
