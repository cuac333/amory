...
const STICKER_PACKS: StickerPack[] = [
  {
    id: "love", name: "Amor", icon: "\u2764\uFE0F",
    stickers: [
      { id: "heart-eyes", emoji: "\uD83D\uDE0D", label: "Enamorado" },
      { id: "kiss", emoji: "\uD83D\uDE18", label: "Beso" },
      { id: "hearts", emoji: "\uD83E\uDD70", label: "Corazones" },
      { id: "hug", emoji: "\uD83E\uDD17", label: "Abrazo" },
      { id: "couple-heart", emoji: "\uD83D\uDC91", label: "Pareja" },
      { id: "love-letter", emoji: "\uD83D\uDC8C", label: "Carta" },
      { id: "heart-grow", emoji: "\uD83D\uDC97", label: "Crece" },
      { id: "two-hearts", emoji: "\uD83D\uDC95", label: "Dos corazones" },
      { id: "cupid", emoji: "\uD83D\uDC98", label: "Cupido" },
      { id: "sparkle-heart", emoji: "\uD83D\uDC96", label: "Brillante" },
      { id: "revolving", emoji: "\uD83D\uDC9E", label: "Girando" },
      { id: "kiss-mark", emoji: "\uD83D\uDC8B", label: "Marca beso" },
    ],
  },
  {
    id: "feelings", name: "Sentimientos", icon: "\uD83E\uDD79",
    stickers: [
      { id: "happy", emoji: "\uD83D\uDE04", label: "Feliz" },
      { id: "laugh-cry", emoji: "\uD83D\uDE02", label: "Muero de risa" },
      { id: "wink", emoji: "\uD83D\uDE09", label: "Guiño" },
      { id: "tongue", emoji: "\uD83D\uDE1C", label: "Lengua" },
      { id: "cool", emoji: "\uD83D\uDE0E", label: "Cool" },
      { id: "shy", emoji: "\uD83D\uDE33", label: "Vergüenza" },
      { id: "cry", emoji: "\uD83D\uDE2D", label: "Llorando" },
      { id: "angry", emoji: "\uD83D\uDE24", label: "Molesto" },
      { id: "thinking", emoji: "\uD83E\uDD14", label: "Pensando" },
      { id: "surprise", emoji: "\uD83D\uDE31", label: "Sorpresa" },
      { id: "sleepy", emoji: "\uD83D\uDE34", label: "Dormido" },
      { id: "sick", emoji: "\uD83E\uDD12", label: "Enfermo" },
    ],
  },
  {
    id: "cute", name: "Tierno", icon: "\uD83E\uDEF6",
    stickers: [
      { id: "pleading", emoji: "\uD83E\uDD7A", label: "Por favor" },
      { id: "puppy", emoji: "\uD83D\uDC36", label: "Perrito" },
      { id: "kitty", emoji: "\uD83D\uDE3B", label: "Gatito" },
      { id: "bunny", emoji: "\uD83D\uDC30", label: "Conejito" },
      { id: "bear", emoji: "\uD83D\uDC3B", label: "Osito" },
      { id: "panda", emoji: "\uD83D\uDC3C", label: "Panda" },
      { id: "flower", emoji: "\uD83C\uDF38", label: "Flor" },
      { id: "bouquet", emoji: "\uD83D\uDC90", label: "Ramo" },
      { id: "star-eyes", emoji: "\uD83E\uDD29", label: "Estrellitas" },
      { id: "rainbow", emoji: "\uD83C\uDF08", label: "Arcoiris" },
  ...
  },
  {
    ...
    stickers: [
      { id: "thumbs-up", emoji: "\uD83D\uDC4D", label: "Bien" },
      { id: "clap", emoji: "\uD83D\uDC4F", label: "Aplauso" },
      { id: "wave", emoji: "\uD83D\uDC4B", label: "Hola" },
      { id: "pray", emoji: "\uD83D\uDE4F", label: "Gracias" },
      { id: "muscle", emoji: "\uD83D\uDCAA", label: "Fuerza" },
      { id: "pinch", emoji: "\uD83E\uDD0F", label: "Poquito" },
      { id: "heart-hands", emoji: "\uD83E\uDEF6", label: "Corazón manos" },
      { id: "fist", emoji: "\uD83D\uDC4A", label: "Puño" },
      { id: "peace", emoji: "\u270C\uFE0F", label: "Paz" },
      { id: "ok", emoji: "\uD83D\uDC4C", label: "Ok" },
      { id: "point-up", emoji: "\u261D\uFE0F", label: "Señalar" },
      { id: "shush", emoji: "\uD83E\uDD2B", label: "Shh" },
    ],
  },
  {
    ...
    stickers: [
      ...
      { id: "ice-cream", emoji: "\uD83C\uDF66", label: "Helado" },
      ...
      { id: "popcorn", emoji: "\uD83C\uDF7F", label: "Palomitas" },
